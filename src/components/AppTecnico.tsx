    ...
    <div className="min-h-screen bg-[#070707] text-white font-sans selection:bg-[#f2b705] selection:text-black">
      ...
      {selectedBudgetForPrint && (
        <div className="fixed inset-0 bg-black/95 z-50 overflow-y-auto flex flex-col justify-start p-4 md:p-8 no-print-backdrop">
          ...
          <div className="max-w-4xl mx-auto w-full bg-zinc-900 border border-zinc-800 p-4 rounded-xl mb-6 flex justify-between items-center no-print">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="bg-[#f2b705] text-black font-extrabold text-[10.5px] uppercase tracking-wider px-3.5 py-1.5 rounded-lg hover:bg-[#f2b705]/90 transition-all font-mono cursor-pointer flex items-center gap-1.5 shadow-[0_0_12px_rgba(242,183,5,0.2)]"
              >
                <Printer className="w-3.5 h-3.5" /> Baixar PDF / Imprimir
              </button>
              <button
                onClick={() => setSelectedBudgetForPrint(null)}
                className="bg-zinc-800 text-zinc-400 hover:text-white font-bold text-xs p-1.5 rounded-lg cursor-pointer transition-colors"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
        ...
        <div className="fixed inset-0 bg-black/95 z-50 overflow-y-auto flex flex-col justify-start p-4 md:p-8 no-print-backdrop">
          ...
          <div className="max-w-3xl mx-auto w-full bg-zinc-900 border border-zinc-800 p-4 rounded-xl mb-6 flex justify-between items-center no-print">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => window.print()}
                className="bg-green-500 text-black font-extrabold text-[10.5px] uppercase tracking-wider px-3.5 py-1.5 rounded-lg hover:bg-green-600 transition-all font-mono cursor-pointer flex items-center gap-1.5 shadow-[0_0_12px_rgba(34,197,94,0.2)]"
              >
